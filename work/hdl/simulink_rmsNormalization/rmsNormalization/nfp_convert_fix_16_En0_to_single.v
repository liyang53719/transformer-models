// -------------------------------------------------------------
// 
// File Name: /home/yang/Documents/prj/matlab_DL_transfromer/transformer_models_neo/work/hdl/simulink_rmsNormalization/rmsNormalization/nfp_convert_fix_16_En0_to_single.v
...
// Source Path: rmsNormalization/DUT/Controller/nfp_convert_fix_16_En0_to_single
// Hierarchy Level: 2
// Model version: 1.1
// 
...
module nfp_convert_fix_16_En0_to_single
  ...
  wire signed [15:0] Data_Type_Conversion1_out1;  // sfix16
  wire signed [16:0] Unary_Minus_in0;  // sfix17
  wire [15:0] Unary_Minus_1;  // ufix16
  wire signed [16:0] Unary_Minus_2;  // sfix17
  ...
  reg [127:0] Delay2_reg_next [0:2];  // ufix128 [3]
  reg [127:0] Delay2_out1_3;  // ufix128
  ...
  assign CompareToZero1_out1 = Delay_out1 == 16'b0000000000000000;
  ...
  assign Data_Type_Conversion_out1 = {112'b0, Switch_out1};
    ...
    begin : Delay2_3_process
      if (reset == 1'b1) begin
        for(Delay2_t_1 = 32'sd0; Delay2_t_1 <= 32'sd2; Delay2_t_1 = Delay2_t_1 + 32'sd1) begin
          Delay2_reg[Delay2_t_1] <= 128'h00000000000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
...
endmodule  // nfp_convert_fix_16_En0_to_single
