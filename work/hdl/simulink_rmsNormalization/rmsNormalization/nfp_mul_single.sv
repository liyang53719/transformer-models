// -------------------------------------------------------------
// 
// File Name: /home/yang/Documents/prj/matlab_DL_transfromer/transformer_models_neo/work/hdl/simulink_rmsNormalization/rmsNormalization/nfp_mul_single.sv
...
// Source Path: rmsNormalization/DUTPacked/CoreDUT/BeatAccumulator0/nfp_mul_single
// Hierarchy Level: 3
// Model version: 1.1
// 
...
module nfp_mul_single
  ...
  logic [7:0] Add_out1;  /* uint8 */
  logic [7:0] Delay3_out1_1;  /* uint8 */
  ...
  logic [23:0] Delay1_out1;  /* ufix24 */
  logic [47:0] Product_out1;  /* ufix48 */
  vector_of_unsigned_logic_48 Delay4_reg [0:2];  /* ufix48 [3] */
  logic [47:0] Delay4_out1_1;  /* ufix48 */
  logic Constant1_out1_1;
  logic [48:0] Bit_Concat_out1_1;  /* ufix49 */
  logic [48:0] Delay3_out1_2;  /* ufix49 */
  ...
  logic [31:0] Add_6;  /* ufix32 */
  logic [31:0] Add_7;  /* ufix32 */
  logic [23:0] Add_out1_2;  /* ufix24 */
  logic [23:0] Delay_out1_2;  /* ufix24 */
  ...
  logic signed [31:0] Add_9;  /* sfix32 */
  logic signed [31:0] Add_10;  /* sfix32 */
  logic [7:0] Add_out1_3;  /* uint8 */
  ...
  logic [22:0] Delay2_out1_3;  /* ufix23 */
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay4_1_process
      if (reset == 1'b1) begin
        Delay4_reg <= '{3{48'h000000000000}};
      end
      else begin
        if (enb) begin
          Delay4_reg[0] <= Product_out1;
          Delay4_reg[32'sd1:32'sd2] <= Delay4_reg[32'sd0:32'sd1];
        end
      end
    end
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay4_3_process
      if (reset == 1'b1) begin
        Delay4_reg_1 <= '{4{10'sb0000000000}};
      end
      else begin
        if (enb) begin
          Delay4_reg_1[0] <= Switch2_out1_1;
          Delay4_reg_1[32'sd1:32'sd3] <= Delay4_reg_1[32'sd0:32'sd2];
        end
      end
    end
