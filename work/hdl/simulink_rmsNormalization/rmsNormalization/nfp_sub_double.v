// -------------------------------------------------------------
// 
// File Name: /home/yang/Documents/prj/matlab_DL_transfromer/transformer_models_neo/work/hdl/simulink_rmsNormalization/rmsNormalization/nfp_sub_double.v
...
// Source Path: rmsNormalization/DUT/Controller/nfp_sub_double
// Hierarchy Level: 2
// Model version: 1.1
// 
...
module nfp_sub_double
  ...
  reg  [7:0] Delay18_PS_7_10_reg;  // ufix1 [8]
  ...
  reg [10:0] Delay2_PS_7_reg_next [0:3];  // ufix11 [4]
  reg [10:0] Delay2_PS_7_out1;  // ufix11
  ...
  reg  [1:0] Delay6_PS_2_reg;  // ufix1 [2]
  ...
  wire signed [57:0] alpha_mant_b_ext_in0;  // sfix58
  wire signed [57:0] alpha_mant_b_ext_1;  // sfix58
  wire signed [56:0] alpha_mant_b_ext_out1;  // sfix57
  ...
  reg  [1:0] Delay9_PS_8_reg;  // ufix1 [2]
  ...
  reg  [7:0] Delay14_PS_7_10_reg;  // ufix1 [8]
  wire Delay14_PS_7_10_out1;  // ufix1
  wire alpha_aSign_1_bSign_1_out1;  // ufix1
  reg  [7:0] Delay13_PS_7_10_reg;  // ufix1 [8]
  ...
  reg [10:0] Delay15_PS_7_10_reg_next [0:7];  // ufix11 [8]
  reg [10:0] Delay15_PS_7_10_out1;  // ufix11
  ...
  reg [51:0] Delay17_PS_7_10_reg_next [0:6];  // ufix52 [7]
  reg [51:0] Delay17_PS_7_10_out1;  // ufix52
  wire [51:0] if_aExponent_cfType_Exponent_1_out1;  // ufix52
  reg [51:0] Delay8_PS_11_out1;  // ufix52
  wire [63:0] nfp_out_pack;  // ufix64
  reg signed [31:0] Delay2_PS_7_t_0_0;  // int32
  reg signed [31:0] Delay2_PS_7_t_0_1;  // int32
  reg signed [31:0] Delay2_PS_7_t_1;  // int32
  reg signed [31:0] Delay1_PS_5_t_0_0;  // int32
  reg signed [31:0] Delay1_PS_5_t_1;  // int32
  reg signed [31:0] Delay7_PS_8_t_0_0;  // int32
  reg signed [31:0] Delay7_PS_8_t_1;  // int32
  reg signed [31:0] Delay15_PS_7_10_t_0_0;  // int32
  reg signed [31:0] Delay15_PS_7_10_t_0_1;  // int32
  reg signed [31:0] Delay15_PS_7_10_t_1;  // int32
  reg signed [31:0] Delay17_PS_7_10_t_0_0;  // int32
  reg signed [31:0] Delay17_PS_7_10_t_0_1;  // int32
  reg signed [31:0] Delay17_PS_7_10_t_1;  // int32
  ...
  assign Relational_Operator1_out1 = Delay1_PS_1_out1 == Delay4_PS_1_out1;
  ...
  assign Relational_Operator_out1 = Delay1_PS_1_out1 > Delay4_PS_1_out1;

  assign bitconcat_aExponent_aMantissa_out1 = Delay2_PS_1_out1 >= Delay5_PS_1_out1;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay18_PS_7_10_process
      if (reset == 1'b1) begin
        Delay18_PS_7_10_reg <= {8{1'b0}};
      end
      else begin
        if (enb) begin
          Delay18_PS_7_10_reg[0] <= aExponent_cfType_Exponent_I_out1;
          Delay18_PS_7_10_reg[32'sd7:32'sd1] <= Delay18_PS_7_10_reg[32'sd6:32'sd0];
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : Delay2_PS_7_process
      if (reset == 1'b1) begin
        for(Delay2_PS_7_t_1 = 32'sd0; Delay2_PS_7_t_1 <= 32'sd3; Delay2_PS_7_t_1 = Delay2_PS_7_t_1 + 32'sd1) begin
          Delay2_PS_7_reg[Delay2_PS_7_t_1] <= 11'b00000000000;
        end
      end
      else begin
        if (enb) begin
          for(Delay2_PS_7_t_0_1 = 32'sd0; Delay2_PS_7_t_0_1 <= 32'sd3; Delay2_PS_7_t_0_1 = Delay2_PS_7_t_0_1 + 32'sd1) begin
            Delay2_PS_7_reg[Delay2_PS_7_t_0_1] <= Delay2_PS_7_reg_next[Delay2_PS_7_t_0_1];
          end
        end
      end
    end
  ...
  always @* begin
    ...
    for(Delay2_PS_7_t_0_0 = 32'sd0; Delay2_PS_7_t_0_0 <= 32'sd2; Delay2_PS_7_t_0_0 = Delay2_PS_7_t_0_0 + 32'sd1) begin
      Delay2_PS_7_reg_next[Delay2_PS_7_t_0_0 + 32'sd1] = Delay2_PS_7_reg[Delay2_PS_7_t_0_0];
    end
  ...
  assign alpha_Exponent_0_cfType_Exp_out1 = Exponent_0_out1 | aExponent_cfType_Exponent_I_out1;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay1_PS_5_process
      if (reset == 1'b1) begin
        for(Delay1_PS_5_t_1 = 32'sd0; Delay1_PS_5_t_1 <= 32'sd1; Delay1_PS_5_t_1 = Delay1_PS_5_t_1 + 32'sd1) begin
          Delay1_PS_5_reg[Delay1_PS_5_t_1] <= 57'sh000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(Delay1_PS_5_t_0_0 = 32'sd0; Delay1_PS_5_t_0_0 <= 32'sd1; Delay1_PS_5_t_0_0 = Delay1_PS_5_t_0_0 + 32'sd1) begin
            Delay1_PS_5_reg[Delay1_PS_5_t_0_0] <= Delay1_PS_5_reg_next[Delay1_PS_5_t_0_0];
          end
        end
      end
    end
  ...
  assign Logical_Operator_out1_1 =  ~ Delay3_PS_1_out1;
  ...
  assign alpha_Exponent_0_cfType_Exp_out1_1 = Exponent_0_out1_1 | exp_b_cfType_Exponent_Inf_o_out1;
  ...
  assign alpha_mant_b_ext_1 = {Delay2_PS_3_out1_1[56], Delay2_PS_3_out1_1};
  assign alpha_mant_b_ext_in0 =  - (alpha_mant_b_ext_1);
  assign alpha_mant_b_ext_out1 = alpha_mant_b_ext_in0[56:0];
  ...
  assign Logical_Operator_out1_2 = exp_norm_cfType_Exponent_In_out1 & Delay9_PS_8_out1;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay7_PS_8_process
      if (reset == 1'b1) begin
        for(Delay7_PS_8_t_1 = 32'sd0; Delay7_PS_8_t_1 <= 32'sd1; Delay7_PS_8_t_1 = Delay7_PS_8_t_1 + 32'sd1) begin
          Delay7_PS_8_reg[Delay7_PS_8_t_1] <= 56'h00000000000000;
        end
      end
      else begin
        if (enb) begin
          for(Delay7_PS_8_t_0_0 = 32'sd0; Delay7_PS_8_t_0_0 <= 32'sd1; Delay7_PS_8_t_0_0 = Delay7_PS_8_t_0_0 + 32'sd1) begin
            Delay7_PS_8_reg[Delay7_PS_8_t_0_0] <= Delay7_PS_8_reg_next[Delay7_PS_8_t_0_0];
          end
        end
      end
    end
  ...
  assign Logical_Operator_out1_3 = Bit_Slice3_out1 | Bit_Slice2_out1_2;
  ...
  assign Logical_Operator_out1_4 = Logical_Operator12_out1_3 | Logical_Operator12_out1_4;
  ...
  assign Switch1_out1_1 = (Logical_Operator_out1_4 == 1'b0 ? Switch_out1_1 :
              Switch2_out1_1);
  ...
  assign shift_length_exp_a_cor_out1 = Delay_PS_7_out1 >= Bit_Slice_out1_2;

  assign Bit_Slice1_out1_2 = Delay2_PS_7_out1[10:6];

  assign Compare_To_Zero_out1_1 = Bit_Slice1_out1_2 == 5'b00000;

  assign Logical_Operator1_out1_2 = shift_length_exp_a_cor_out1 & Compare_To_Zero_out1_1;
  ...
  assign Logical_Operator_out1_5 =  ~ Bit_Slice1_out1_3;
  ...
  assign Logical_Operator_out1_6 = Logical_Operator_out1_5 & Logical_Operator11_out1;

  assign Bit_Slice1_out1_4 = Delay7_PS_4_out1[2];

  assign Logical_Operator2_out1_3 = Logical_Operator_out1_6 & Bit_Slice1_out1_4;
  ...
  assign Logical_Operator_out1_7 =  ~ Bit_Slice2_out1_3;

  assign Logical_Operator1_out1_4 = Logical_Operator2_out1_4 & Logical_Operator_out1_7;

  assign Switch_out1_2 = (Logical_Operator1_out1_4 == 1'b0 ? Logical_Operator_out1_6 :
  ...
  assign if_bitget_Mant_tmp_1_0_out1 = (alpha_bitget_Mant_tmp_1_0_out1 == 1'b0 ? Bit_Concat_out1_2 :
  ...
  assign Switch_out1_3 = (Delay18_PS_7_10_out1 == 1'b0 ? alpha_Exponent_0_Mantissa_out1 :
              Constant_out1_3);

  always @(posedge clk or posedge reset)
    begin : Delay14_PS_7_10_process
      if (reset == 1'b1) begin
        Delay14_PS_7_10_reg <= {8{1'b0}};
      end
      else begin
        if (enb) begin
          Delay14_PS_7_10_reg[0] <= if_bitconcat_aExponent_aMantiss_2_out1;
          Delay14_PS_7_10_reg[32'sd7:32'sd1] <= Delay14_PS_7_10_reg[32'sd6:32'sd0];
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : Delay13_PS_7_10_process
      if (reset == 1'b1) begin
        Delay13_PS_7_10_reg <= {8{1'b0}};
      end
      else begin
        if (enb) begin
          Delay13_PS_7_10_reg[0] <= alpha_aSign_1_bSign_1_out1;
          Delay13_PS_7_10_reg[32'sd7:32'sd1] <= Delay13_PS_7_10_reg[32'sd6:32'sd0];
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : Delay15_PS_7_10_process
      if (reset == 1'b1) begin
        for(Delay15_PS_7_10_t_1 = 32'sd0; Delay15_PS_7_10_t_1 <= 32'sd7; Delay15_PS_7_10_t_1 = Delay15_PS_7_10_t_1 + 32'sd1) begin
          Delay15_PS_7_10_reg[Delay15_PS_7_10_t_1] <= 11'b00000000000;
        end
      end
      else begin
        if (enb) begin
          for(Delay15_PS_7_10_t_0_1 = 32'sd0; Delay15_PS_7_10_t_0_1 <= 32'sd7; Delay15_PS_7_10_t_0_1 = Delay15_PS_7_10_t_0_1 + 32'sd1) begin
            Delay15_PS_7_10_reg[Delay15_PS_7_10_t_0_1] <= Delay15_PS_7_10_reg_next[Delay15_PS_7_10_t_0_1];
          end
        end
      end
    end
  ...
  always @* begin
    ...
    for(Delay15_PS_7_10_t_0_0 = 32'sd0; Delay15_PS_7_10_t_0_0 <= 32'sd6; Delay15_PS_7_10_t_0_0 = Delay15_PS_7_10_t_0_0 + 32'sd1) begin
      Delay15_PS_7_10_reg_next[Delay15_PS_7_10_t_0_0 + 32'sd1] = Delay15_PS_7_10_reg[Delay15_PS_7_10_t_0_0];
    end
  ...
  assign alpha_mant_a_0_opp_signs_out1 = mant_a_0_out1 | opp_signs_exp_b_cfType_out1;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay17_PS_7_10_process
      if (reset == 1'b1) begin
        for(Delay17_PS_7_10_t_1 = 32'sd0; Delay17_PS_7_10_t_1 <= 32'sd6; Delay17_PS_7_10_t_1 = Delay17_PS_7_10_t_1 + 32'sd1) begin
          Delay17_PS_7_10_reg[Delay17_PS_7_10_t_1] <= 52'h0000000000000;
        end
      end
      else begin
        if (enb) begin
          for(Delay17_PS_7_10_t_0_1 = 32'sd0; Delay17_PS_7_10_t_0_1 <= 32'sd6; Delay17_PS_7_10_t_0_1 = Delay17_PS_7_10_t_0_1 + 32'sd1) begin
            Delay17_PS_7_10_reg[Delay17_PS_7_10_t_0_1] <= Delay17_PS_7_10_reg_next[Delay17_PS_7_10_t_0_1];
          end
        end
      end
    end
  ...
  always @* begin
    ...
    for(Delay17_PS_7_10_t_0_0 = 32'sd0; Delay17_PS_7_10_t_0_0 <= 32'sd5; Delay17_PS_7_10_t_0_0 = Delay17_PS_7_10_t_0_0 + 32'sd1) begin
      Delay17_PS_7_10_reg_next[Delay17_PS_7_10_t_0_0 + 32'sd1] = Delay17_PS_7_10_reg[Delay17_PS_7_10_t_0_0];
    end
