// -------------------------------------------------------------
// 
// File Name: /home/yang/Documents/prj/matlab_DL_transfromer/transformer_models_neo/work/hdl/simulink_rmsNormalization/rmsNormalization/nfp_add_single.sv
...
// Source Path: rmsNormalization/DUTPacked/CoreDUT/BeatAccumulator0/nfp_add_single
// Hierarchy Level: 3
// Model version: 1.1
// 
...
module nfp_add_single
  ...
  logic [22:0] Delay1_out1_1;  /* ufix23 */
  logic [22:0] Delay4_out1_1;  /* ufix23 */
  ...
  logic signed [27:0] Delay2_out1_3;  /* sfix28 */
  vector_of_signed_logic_28 Delay5_reg [0:1];  /* sfix28 [2] */
  logic signed [27:0] Delay5_out1_2;  /* sfix28 */
  ...
  logic signed [27:0] Delay1_out1_2;  /* sfix28 */
  logic signed [28:0] alpha_mant_b_ext_in0;  /* sfix29 */
  logic signed [28:0] alpha_mant_b_ext_1;  /* sfix29 */
  logic signed [27:0] alpha_mant_b_ext_out1;  /* sfix28 */
  logic signed [27:0] if_opp_Sign_out1;  /* sfix28 */
  logic signed [27:0] Delay6_out1_1;  /* sfix28 */
  logic [7:0] C_out1_1;  /* ufix8 */
  logic [7:0] if_Exponent_0_out1_1;  /* ufix8 */
  logic [7:0] Delay_out1_2;  /* ufix8 */
  ...
  logic [26:0] Delay_out1_3;  /* ufix27 */
  logic BitSlice_out1;  /* ufix1 */
  logic [1:0] Delay9_reg;  /* ufix1 [2] */
  logic Delay9_out1;  /* ufix1 */
  logic Logical_Operator_out1_1;  /* ufix1 */
  logic Delay13_out1;  /* ufix1 */
  vector_of_unsigned_logic_27 Delay7_reg [0:1];  /* ufix27 [2] */
  logic [26:0] Delay7_out1_1;  /* ufix27 */
  ...
  logic [26:0] Delay15_out1;  /* ufix27 */
  ...
  logic Delay_out1_5;  /* ufix1 */
  logic Delay2_out1_4;  /* ufix1 */
  logic [1:0] Delay11_reg;  /* ufix1 [2] */
  logic Delay11_out1;  /* ufix1 */
  logic BitSlice1_out1;  /* ufix1 */
  logic sticky_bitget_Sum_1_out1;  /* ufix1 */
  logic [1:0] Delay10_reg;  /* ufix1 [2] */
  logic Delay10_out1_1;  /* ufix1 */
  logic if_bitget_Sum_Sum_WordLength_2_out1;  /* ufix1 */
  logic BitSlice_out1_1;  /* ufix1 */
  logic BitSlice1_out1_1;  /* ufix1 */
  logic Delay19_out1;  /* ufix1 */
  ...
  logic [23:0] Delay_out1_6;  /* ufix24 */
  ...
  logic [7:0] Delay14_out1;  /* ufix8 */
  logic [7:0] if_bitget_Sum_Sum_WordLength_out1_1;  /* ufix8 */
  logic [7:0] Delay1_out1_4;  /* ufix8 */
  ...
  logic alpha_Exponent_0_Mantissa_out1;  /* ufix1 */
  logic Constant_out1_2;  /* ufix1 */
  logic Switch_out1_1;  /* ufix1 */
  logic [7:0] Delay14_reg;  /* ufix1 [8] */
  logic Delay14_out1_1;  /* ufix1 */
  logic alpha_aSign_1_bSign_1_out1;  /* ufix1 */
  logic [7:0] Delay13_reg;  /* ufix1 [8] */
  logic Delay13_out1_1;  /* ufix1 */
  logic if_Exponent_0_Mantissa_out1;  /* ufix1 */
  logic Delay6_out1_3;  /* ufix1 */
  vector_of_unsigned_logic_8 Delay15_reg [0:7];  /* ufix8 [8] */
  logic [7:0] Delay15_out1_1;  /* ufix8 */
  logic [7:0] if_aExponent_cfType_Exponent_out1;  /* ufix8 */
  logic [7:0] Delay7_out1_2;  /* ufix8 */
  logic opp_signs_exp_b_cfType_out1;  /* ufix1 */
  logic mant_a_0_out1;  /* ufix1 */
  logic alpha_mant_a_0_opp_signs_out1;  /* ufix1 */
  logic [22:0] BitSet_out1;  /* ufix23 */
  logic [22:0] if_mant_a_0_opp_signs_out1;  /* ufix23 */
  logic [22:0] Delay2_out1_5;  /* ufix23 */
  vector_of_unsigned_logic_23 Delay17_reg [0:6];  /* ufix23 [7] */
  logic [22:0] Delay17_out1;  /* ufix23 */
  logic [22:0] if_aExponent_cfType_Exponent_1_out1;  /* ufix23 */
  logic [22:0] Delay8_out1_1;  /* ufix23 */
    ...
    begin : Delay2_2_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          ...
          Delay2_reg[32'sd1:32'sd3] <= Delay2_reg[32'sd0:32'sd2];
        end
      end
    end
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay5_2_process
      if (reset == 1'b1) begin
        Delay5_reg <= '{2{28'sb0000000000000000000000000000}};
      end
      else begin
        if (enb) begin
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay7_1_process
      if (reset == 1'b1) begin
        Delay7_reg <= '{2{27'b000000000000000000000000000}};
      end
      else begin
        if (enb) begin
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay15_1_process
      if (reset == 1'b1) begin
        Delay15_reg <= '{8{8'b00000000}};
      end
      else begin
        if (enb) begin
          Delay15_reg[0] <= if_bitconcat_aExponent_aMantiss_out1;
          Delay15_reg[32'sd1:32'sd7] <= Delay15_reg[32'sd0:32'sd6];
        end
      end
    end
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delay17_process
      if (reset == 1'b1) begin
        Delay17_reg <= '{7{23'b00000000000000000000000}};
      end
      else begin
        if (enb) begin
          Delay17_reg[0] <= Delay2_out1_5;
          Delay17_reg[32'sd1:32'sd6] <= Delay17_reg[32'sd0:32'sd5];
        end
      end
    end
