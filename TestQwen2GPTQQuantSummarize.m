...
% Use exact GPTQ packed replay for parity. The quant_sim mode injects
% activation-side simulation intended for hardware studies rather than
% exact equality against the Python GPTQ runtime.
mdlM.Parameters.RuntimeConfig = struct('LinearMode', 'gptq_int4_matlab_sim', ...
